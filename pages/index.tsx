            ...
            <div>
              <div className="relative min-h-[400px] flex items-center justify-center">
                ...
                <div className="relative z-10 w-full max-w-lg">
                  <div className="absolute inset-0 bg-devops-cyan/20 blur-3xl rounded-full"></div>
                  <img 
                ...
                {/* Tech Icons around the graphic with labels */}
                ...
                <div className="absolute top-1/2 left-8 -translate-y-1/2 md:left-12">
